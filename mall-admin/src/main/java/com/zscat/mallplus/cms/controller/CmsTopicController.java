...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有话题表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存话题表")
@ApiOperation("保存话题表")
...
@SysLog(MODULE = "sys", REMARK = "更新话题表")
@ApiOperation("更新话题表")
...
@SysLog(MODULE = "sys", REMARK = "删除话题表")
@ApiOperation("删除话题表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("话题表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给话题表分配话题表")
@ApiOperation("查询话题表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("话题表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("话题表id");
        }
