...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有帮助分类表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存帮助分类表")
...
@SysLog(MODULE = "sys", REMARK = "更新帮助分类表")
...
@SysLog(MODULE = "sys", REMARK = "删除帮助分类表")
@ApiOperation("删除帮助分类表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("帮助分类表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给帮助分类表分配帮助分类表")
@ApiOperation("查询帮助分类表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("帮助分类表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("帮助分类表id");
        }
