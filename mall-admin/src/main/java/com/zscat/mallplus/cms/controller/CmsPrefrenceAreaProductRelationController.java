...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有优选专区和产品关系表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存优选专区和产品关系表")
...
@SysLog(MODULE = "sys", REMARK = "更新优选专区和产品关系表")
...
@SysLog(MODULE = "sys", REMARK = "删除优选专区和产品关系表")
@ApiOperation("删除优选专区和产品关系表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("优选专区和产品关系表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给优选专区和产品关系表分配优选专区和产品关系表")
@ApiOperation("查询优选专区和产品关系表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("优选专区和产品关系表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("优选专区和产品关系表id");
        }
