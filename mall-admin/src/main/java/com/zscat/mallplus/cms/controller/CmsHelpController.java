...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有帮助表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存帮助表")
@ApiOperation("保存帮助表")
...
@SysLog(MODULE = "sys", REMARK = "更新帮助表")
@ApiOperation("更新帮助表")
...
@SysLog(MODULE = "sys", REMARK = "删除帮助表")
@ApiOperation("删除帮助表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("帮助表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给帮助表分配帮助表")
@ApiOperation("查询帮助表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("帮助表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("帮助表id");
        }
