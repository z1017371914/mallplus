...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有专题表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存专题表")
@ApiOperation("保存专题表")
...
@SysLog(MODULE = "sys", REMARK = "更新专题表")
@ApiOperation("更新专题表")
...
@SysLog(MODULE = "sys", REMARK = "删除专题表")
@ApiOperation("删除专题表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("专题表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给专题表分配专题表")
@ApiOperation("查询专题表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("专题表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("专题表id");
        }
