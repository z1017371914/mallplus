...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有订单中所包含的商品列表")
...
@SysLog(MODULE = "sys", REMARK = "保存订单中所包含的商品")
...
@SysLog(MODULE = "sys", REMARK = "更新订单中所包含的商品")
...
@SysLog(MODULE = "sys", REMARK = "删除订单中所包含的商品")
@ApiOperation("删除订单中所包含的商品")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("订单中所包含的商品id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给订单中所包含的商品分配订单中所包含的商品")
@ApiOperation("查询订单中所包含的商品明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("订单中所包含的商品id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("订单中所包含的商品id");
        }
