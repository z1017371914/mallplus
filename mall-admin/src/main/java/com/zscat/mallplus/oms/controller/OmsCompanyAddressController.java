...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有公司收发货地址表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存公司收发货地址表")
...
@SysLog(MODULE = "sys", REMARK = "更新公司收发货地址表")
...
@SysLog(MODULE = "sys", REMARK = "删除公司收发货地址表")
@ApiOperation("删除公司收发货地址表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("公司收发货地址表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给公司收发货地址表分配公司收发货地址表")
@ApiOperation("查询公司收发货地址表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("公司收发货地址表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("公司收发货地址表id");
        }
