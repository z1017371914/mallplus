...
@SysLog(MODULE = "sys", REMARK = "根据条件查询所有购物车表列表")
...
@SysLog(MODULE = "sys", REMARK = "保存购物车表")
@ApiOperation("保存购物车表")
...
@SysLog(MODULE = "sys", REMARK = "更新购物车表")
@ApiOperation("更新购物车表")
...
@SysLog(MODULE = "sys", REMARK = "删除购物车表")
@ApiOperation("删除购物车表")
@DeleteMapping(value = "/delete/{id}")
@PreAuthorize("hasAuthority('sys:role:delete')")
public Object deleteRole(@ApiParam("购物车表id") @PathVariable Long id){
        try{
...
@SysLog(MODULE = "sys", REMARK = "给购物车表分配购物车表")
@ApiOperation("查询购物车表明细")
@GetMapping(value = "/{id}")
@PreAuthorize("hasAuthority('sys:role:read')")
public Object getRoleById(@ApiParam("购物车表id") @PathVariable Long id){
        try{
        if(ValidatorUtils.empty(id)){
        return new CommonResult().paramFailed("购物车表id");
        }
